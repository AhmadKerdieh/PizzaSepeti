  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs</div>
        <div class="panel-footer"><%= hope.load.price(1000) %></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(1001) %></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(1002) %></div>
     ...
     <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 200</div>
        <div class="panel-footer"><%= hope.load.price(1003) %></div>
     ...
     <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 200</div>
        <div class="panel-footer"><%= hope.load.price(1004) %></div>
     ...
     <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 200</div>
        <div class="panel-footer"><%= hope.load.price(1005) %></div>
     ...
     <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 200</div>
        <div class="panel-footer"><%= hope.load.price(1006) %></div>
     ...
     <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 200</div>
        <div class="panel-footer"><%= hope.load.price(1007) %></div>
     ...
     <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer">Rs. 200</div>
        <div class="panel-footer"><%= hope.load.price(1008) %></div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(3000) %></div>
     ...
     <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(3001) %></div>
     ...
     <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(3002) %></div>
   ...
   <div class="panel panel-danger">
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(2000) %></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(2001) %></div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(2002) %></div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(2003) %></div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(2004) %></div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><%= hope.load.price(2005) %></div>
